---
layout: post
title: "Dapper：谷歌的大规模分布式跟踪系统"
subtitle: "谷歌的大规模分布式跟踪系统"
date: 2017-05-15
...
tags: Dapper Google 分布式 跟踪系统
keyword: Dapper, Google, 分布式, 跟踪系统
finished: true
---


> 原文出处: [Benjamin H. Sigelman, Luiz André Barroso 等](https://research.google.com/pubs/pub36356.html) 译文出处: [bigbully](http://bigbully.github.io/Dapper-translation/)    
> [PDF]({{ post.url| prepend: site.url  }}/content/PDF/2017/google-dapper-36356.pdf) 
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper01.jpg)   
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper02.jpg)  
图2：5个span在Dapper跟踪树种短暂的关联关系  
  ...
  ![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper03.jpg)  
...
## 2.3 Annotation  
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper04.jpg)    
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper05.jpg)    
图5：Dapper收集管道的总览
## 2.5 跟踪的收集
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper06.jpg)   
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper07.jpg)   
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper08.jpg)   
图6
...
![Dapper]({{ post.url| prepend: site.url  }}/content/images/201708/dapper09.jpg)  
